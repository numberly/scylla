...
namespace thrift_tcxx = tcxx;
#else
namespace thrift_tcxx = std;
#endif
...
void pass_unimplemented(const thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)>& exn_cob) {
...
void
with_cob(thrift_tcxx::function<void (const T& ret)>&& cob,
        thrift_tcxx::function<void (::apache::thrift::TDelayedException* _throw)>&& exn_cob,
        Func&& func) {
...
void
with_cob(thrift_tcxx::function<void ()>&& cob,
        thrift_tcxx::function<void (::apache::thrift::TDelayedException* _throw)>&& exn_cob,
        Func&& func) {
    // then_wrapped() terminates the fiber by calling one of the cob objects
...
template <typename Func>
void
with_exn_cob(thrift_tcxx::function<void (::apache::thrift::TDelayedException* _throw)>&& exn_cob, Func&& func) {
    // then_wrapped() terminates the fiber by calling one of the cob objects
...
public:
    ...
    void login(thrift_tcxx::function<void()> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const AuthenticationRequest& auth_request) {
    ...
    void set_keyspace(thrift_tcxx::function<void()> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& keyspace) {
        with_cob(std::move(cob), std::move(exn_cob), [&] {
            _query_state.get_client_state().set_keyspace(_db.local(), keyspace);
        });
    }

    void get(thrift_tcxx::function<void(ColumnOrSuperColumn const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& key, const ColumnPath& column_path, const ConsistencyLevel::type consistency_level) {
    ...
    void get_slice(thrift_tcxx::function<void(std::vector<ColumnOrSuperColumn>  const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& key, const ColumnParent& column_parent, const SlicePredicate& predicate, const ConsistencyLevel::type consistency_level) {
    ...
    void get_count(thrift_tcxx::function<void(int32_t const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& key, const ColumnParent& column_parent, const SlicePredicate& predicate, const ConsistencyLevel::type consistency_level) {
    ...
    void multiget_slice(thrift_tcxx::function<void(std::map<std::string, std::vector<ColumnOrSuperColumn> >  const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::vector<std::string> & keys, const ColumnParent& column_parent, const SlicePredicate& predicate, const ConsistencyLevel::type consistency_level) {
    ...
    void multiget_count(thrift_tcxx::function<void(std::map<std::string, int32_t>  const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::vector<std::string> & keys, const ColumnParent& column_parent, const SlicePredicate& predicate, const ConsistencyLevel::type consistency_level) {
        with_schema(std::move(cob), std::move(exn_cob), column_parent.column_family, [&](schema_ptr schema) {
            if (!column_parent.super_column.empty()) {
                fail(unimplemented::cause::SUPER);
            }
     ...
     */
    void get_range_slices(thrift_tcxx::function<void(std::vector<KeySlice>  const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const ColumnParent& column_parent, const SlicePredicate& predicate, const KeyRange& range, const ConsistencyLevel::type consistency_level) {
        with_schema(std::move(cob), std::move(exn_cob), column_parent.column_family, [&](schema_ptr schema) {
            if (!column_parent.super_column.empty()) {
                fail(unimplemented::cause::SUPER);
            }
    ...
    void get_paged_slice(thrift_tcxx::function<void(std::vector<KeySlice> const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& column_family, const KeyRange& range, const std::string& start_column, const ConsistencyLevel::type consistency_level) {
    ...
    void get_indexed_slices(thrift_tcxx::function<void(std::vector<KeySlice>  const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const ColumnParent& column_parent, const IndexClause& index_clause, const SlicePredicate& column_predicate, const ConsistencyLevel::type consistency_level) {
    ...
    void insert(thrift_tcxx::function<void()> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& key, const ColumnParent& column_parent, const Column& column, const ConsistencyLevel::type consistency_level) {
        with_schema(std::move(cob), std::move(exn_cob), column_parent.column_family, [&](schema_ptr schema) {
            ...
            return _query_state.get_client_state().has_schema_access(*schema, auth::permission::MODIFY).then([this, m_to_apply = std::move(m_to_apply), consistency_level] {
                ...
                return service::get_local_storage_proxy().mutate({std::move(m_to_apply)}, cl_from_thrift(consistency_level), timeout, nullptr);
            });
        });
    }

    void add(thrift_tcxx::function<void()> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& key, const ColumnParent& column_parent, const CounterColumn& column, const ConsistencyLevel::type consistency_level) {
        with_schema(std::move(cob), std::move(exn_cob), column_parent.column_family, [&](schema_ptr schema) {
            if (column_parent.__isset.super_column) {
                fail(unimplemented::cause::SUPER);
            }
    ...
    void remove(thrift_tcxx::function<void()> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& key, const ColumnPath& column_path, const int64_t timestamp, const ConsistencyLevel::type consistency_level) {
    ...
    void remove_counter(thrift_tcxx::function<void()> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& key, const ColumnPath& column_path, const ConsistencyLevel::type consistency_level) {
        with_schema(std::move(cob), std::move(exn_cob), column_path.column_family, [&](schema_ptr schema) {
            mutation m_to_apply(schema, key_from_thrift(*schema, to_bytes_view(key)));
    ...
    void batch_mutate(thrift_tcxx::function<void()> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::map<std::string, std::map<std::string, std::vector<Mutation> > > & mutation_map, const ConsistencyLevel::type consistency_level) {
        with_cob(std::move(cob), std::move(exn_cob), [&] {
            ...
            return parallel_for_each(std::move(p.second), [this](auto&& schema) {
                ...
                auto timeout = db::timeout_clock::now() + _timeout_config.write_timeout;
                return service::get_local_storage_proxy().mutate(std::move(muts), cl_from_thrift(consistency_level), timeout, nullptr);
            });
        });
    }

    void atomic_batch_mutate(thrift_tcxx::function<void()> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::map<std::string, std::map<std::string, std::vector<Mutation> > > & mutation_map, const ConsistencyLevel::type consistency_level) {
        with_cob(std::move(cob), std::move(exn_cob), [&] {
            auto p = prepare_mutations(_db.local(), current_keyspace(), mutation_map);
            return parallel_for_each(std::move(p.second), [this](auto&& schema) {
                return _query_state.get_client_state().has_schema_access(*schema, auth::permission::MODIFY);
                ...
                auto timeout = db::timeout_clock::now() + _timeout_config.write_timeout;
                return service::get_local_storage_proxy().mutate_atomically(std::move(muts), cl_from_thrift(consistency_level), timeout, nullptr);
            });
        });
    }

    void truncate(thrift_tcxx::function<void()> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& cfname) {
        with_cob(std::move(cob), std::move(exn_cob), [&] {
    ...
    void get_multi_slice(thrift_tcxx::function<void(std::vector<ColumnOrSuperColumn>  const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const MultiSliceRequest& request) {
    ...
    void describe_schema_versions(thrift_tcxx::function<void(std::map<std::string, std::vector<std::string> >  const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob) {
        with_cob(std::move(cob), std::move(exn_cob), [] {
    ...
    void describe_keyspaces(thrift_tcxx::function<void(std::vector<KsDef>  const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob) {
        with_cob(std::move(cob), std::move(exn_cob), [&] {
            validate_login();
    ...
    void describe_cluster_name(thrift_tcxx::function<void(std::string const& _return)> cob) {
        cob(_db.local().get_config().cluster_name());
    }

    void describe_version(thrift_tcxx::function<void(std::string const& _return)> cob) {
        cob(::cassandra::thrift_version);
    }

    void do_describe_ring(thrift_tcxx::function<void(std::vector<TokenRange>  const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& keyspace, bool local) {
        with_cob(std::move(cob), std::move(exn_cob), [&] {
    ...
    void describe_ring(thrift_tcxx::function<void(std::vector<TokenRange>  const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& keyspace) {
        do_describe_ring(std::move(cob), std::move(exn_cob), keyspace, false);
    }

    void describe_local_ring(thrift_tcxx::function<void(std::vector<TokenRange>  const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& keyspace) {
        do_describe_ring(std::move(cob), std::move(exn_cob), keyspace, true);
    }

    void describe_token_map(thrift_tcxx::function<void(std::map<std::string, std::string>  const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob) {
        with_cob(std::move(cob), std::move(exn_cob), [] {
    ...
    void describe_partitioner(thrift_tcxx::function<void(std::string const& _return)> cob) {
        cob(dht::global_partitioner().name());
    }

    void describe_snitch(thrift_tcxx::function<void(std::string const& _return)> cob) {
        cob(format("org.apache.cassandra.locator.{}", _db.local().get_snitch_name()));
    }

    void describe_keyspace(thrift_tcxx::function<void(KsDef const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& keyspace) {
        with_cob(std::move(cob), std::move(exn_cob), [&] {
            validate_login();
            auto& ks = _db.local().find_keyspace(keyspace);
    ...
    void describe_splits(thrift_tcxx::function<void(std::vector<std::string>  const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& cfName, const std::string& start_token, const std::string& end_token, const int32_t keys_per_split) {
    ...
    void trace_next_query(thrift_tcxx::function<void(std::string const& _return)> cob) {
        std::string _return;
        // FIXME: implement
        return cob("dummy trace");
    }

    void describe_splits_ex(thrift_tcxx::function<void(std::vector<CfSplit>  const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& cfName, const std::string& start_token, const std::string& end_token, const int32_t keys_per_split) {
        with_cob(std::move(cob), std::move(exn_cob), [&]{
    ...
    void system_add_column_family(thrift_tcxx::function<void(std::string const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const CfDef& cf_def) {
        with_cob(std::move(cob), std::move(exn_cob), [&] {
    ...
    void system_drop_column_family(thrift_tcxx::function<void(std::string const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& column_family) {
        with_cob(std::move(cob), std::move(exn_cob), [&] {
    ...
    void system_add_keyspace(thrift_tcxx::function<void(std::string const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const KsDef& ks_def) {
        with_cob(std::move(cob), std::move(exn_cob), [&] {
    ...
    void system_drop_keyspace(thrift_tcxx::function<void(std::string const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& keyspace) {
        with_cob(std::move(cob), std::move(exn_cob), [&] {
    ...
    void system_update_keyspace(thrift_tcxx::function<void(std::string const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const KsDef& ks_def) {
        with_cob(std::move(cob), std::move(exn_cob), [&] {
    ...
    void system_update_column_family(thrift_tcxx::function<void(std::string const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const CfDef& cf_def) {
        with_cob(std::move(cob), std::move(exn_cob), [&] {
    ...
    void execute_cql_query(thrift_tcxx::function<void(CqlResult const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& query, const Compression::type compression) {
    ...
    void execute_cql3_query(thrift_tcxx::function<void(CqlResult const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& query, const Compression::type compression, const ConsistencyLevel::type consistency) {
    ...
    void prepare_cql_query(thrift_tcxx::function<void(CqlPreparedResult const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& query, const Compression::type compression) {
        throw make_exception<InvalidRequestException>("CQL2 is not supported");
    }
    ...
    void prepare_cql3_query(thrift_tcxx::function<void(CqlPreparedResult const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& query, const Compression::type compression) {
        with_exn_cob(std::move(exn_cob), [&] {
            validate_login();
            if (compression != Compression::type::NONE) {
                throw make_exception<InvalidRequestException>("Compressed query strings are not supported");
    ...
    void execute_prepared_cql_query(thrift_tcxx::function<void(CqlResult const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const int32_t itemId, const std::vector<std::string> & values) {
        throw make_exception<InvalidRequestException>("CQL2 is not supported");
    }

    void execute_prepared_cql3_query(thrift_tcxx::function<void(CqlResult const& _return)> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const int32_t itemId, const std::vector<std::string> & values, const ConsistencyLevel::type consistency) {
        with_exn_cob(std::move(exn_cob), [&] {
    ...
    void set_cql_version(thrift_tcxx::function<void()> cob, thrift_tcxx::function<void(::apache::thrift::TDelayedException* _throw)> exn_cob, const std::string& version) {
        // No-op.
        cob();
    }
